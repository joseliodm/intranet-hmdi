...
$query_qnt_usuarios = "SELECT COUNT(id) AS qnt_usuarios FROM aniversariantes";
...
if(!empty($dados_requisicao['search']['value'])) {
    ...
    $query_qnt_usuarios .= " OR funcao LIKE :funcao ";
    $query_qnt_usuarios .= " OR idade LIKE :dia ";
}
// Preparar a QUERY
...
if(!empty($dados_requisicao['search']['value'])) {
    ...
    $result_qnt_usuarios->bindParam(':funcao', $valor_pesq, PDO::PARAM_STR);
...
$query_usuarios = "SELECT id, nome, funcao, dia 
...
if(!empty($dados_requisicao['search']['value'])) {
    ...
    $query_usuarios .= " OR funcao LIKE :funcao ";
    $query_usuarios .= " OR dia LIKE :dia ";
}
...
if(!empty($dados_requisicao['search']['value'])) {
    ...
    $result_usuarios->bindParam(':funcao', $valor_pesq, PDO::PARAM_STR);
